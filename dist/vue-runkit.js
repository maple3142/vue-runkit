...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_runkit_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_runkit_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_runkit_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_25b74475_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_runkit_vue__ = __webpack_require__(111);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_runkit_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_25b74475_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_runkit_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\runkit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] runkit.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-25b74475", Component.options)
  } else {
    hotAPI.reload("data-v-25b74475", Component.options)
  }
...
if (!('RunKit' in window) && true) console.warn('consider add <script src="https://embed.runkit.com"><\/script> in html\nthis message won\'t show in production build(min.js version)');
...
exports.default = {
	...
	data: function data() {
		return {
			options: (0, _assign2.default)({}, this.option),
			notebook: null
		};
	},
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							for (k in _this.$props) {
								opt[k] = _this.$props[k];
							}
							opt.element = _this.$refs.runkit;

							_this.options.onLoad = function (notebook) {
								_this.$emit('onLoad', _this.notebook);
							};
							_this.options.onEvaluate = function () {
								_this.$emit('onEvaluate', _this.notebook);
							};
							...
							if (!('RunKit' in window)) {
								...
								script.onload = function () {
									_this.notebook = window.RunKit.createNotebook(opt);
								};
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-25b74475", esExports)
  }
}
